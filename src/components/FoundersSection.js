  ...
  return (
    <section ref={containerRef} className="relative overflow-hidden bg-white">
        ...
        <div ref={horizontalRef} className="flex h-screen w-max items-center flex-nowrap">
          ...
          <div className="w-screen h-screen flex items-start pt-20 md:pt-32 lg:pt-40 px-8 md:px-12 lg:px-24 bg-white shrink-0">
            <div className="max-w-4xl">
               <span className="text-[13px] font-bold uppercase tracking-[0.4em] text-[#1D9E75] mb-6 block">— THE PEOPLE BEHIND THE PURITY</span>
               <h2 className="text-7xl lg:text-8xl font-serif font-light text-[#0F2027] leading-[1.1]">
                  Visionary <span className="italic font-bold">Leadership</span>
               </h2>
            ...
            <div key={i} className="w-screen h-screen flex bg-white shrink-0 border-l border-slate-100">
              ...
              <div className="w-[60%] flex flex-col justify-center px-8 md:px-12 lg:px-24">
                <div className="founder-info">
                   <span className="text-[10px] font-bold tracking-[0.5em] text-[#9FE1CB] mb-4 block uppercase">— 0{i+1} / 04</span>
                   <h3 className="text-6xl font-serif font-bold text-[#0F2027] mb-2">{founder.name}</h3>
                   <p className="text-[#1D9E75] text-lg font-bold tracking-widest uppercase mb-8">{founder.role}</p>
          ...
          <div className="w-screen h-screen flex flex-col items-center justify-center bg-[#0F2027] text-white shrink-0">
             <h2 className="text-4xl lg:text-7xl font-serif text-center italic mb-12 px-12">Building the future with <br/> <span className="not-italic font-bold">Unrivaled Purity</span></h2>
             <div className="px-10 py-5 border border-white/20 hover:bg-white hover:text-[#0F2027] transition-all duration-500 rounded-full cursor-pointer uppercase text-xs font-bold tracking-widest">
                Contact the Team
             </div>
          </div>
      ...
      <div className="md:hidden pt-10 pb-24 px-6 space-y-20 founders-mobile border-t border-slate-100">
        <div className="mb-16">
          <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-[#1D9E75] mb-4 block">Leadership</span>
          <h2 className="text-4xl font-serif font-light text-[#0F2027]">Visionary <span className="italic font-bold">Leadership</span></h2>
        </div>
        {founders.map((founder, i) => (
          <div key={i} className="founder-card space-y-6">
            ...
            <div>
               <h3 className="text-3xl font-serif font-bold text-[#0F2027]">{founder.name}</h3>
               <p className="text-[#1D9E75] text-sm font-bold uppercase tracking-widest mb-4">{founder.role}</p>
